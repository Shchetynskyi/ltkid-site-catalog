...
- `Початок` залишено глобально в `src/routes/+layout.svelte` як sticky-навігацію.
- Перемикач `1/2 колонки` винесено у праву частину верхнього bar, але показується тільки в галереї через store `showGalleryViewToggle`.
- Лічильник `Показано: N` прибрано з галереї як другорядний елемент для мобільного UX.
- Локальний дубль кнопки перемикання колонок у галереї видалено.