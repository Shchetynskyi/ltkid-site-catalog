...
## MC-6 v2 — Messenger Prefill (Site Entry Points)

Дата: 2026-02-XX

### Зроблено

1. Сторінка вибору типу лінз  
   `/gallery/ready/[gender]/diopter`

   - Додано людяний prefill без технічних слів
   - Без використання терміну "діоптрія"
   - Інструкція "НАДІСЛАТИ" розміщена в кінці

2. Сторінка моделі `/model/[modelId]`

   - "Діоптрія" замінено на "Лінзи (+/-)"
   - Якщо лінзи не вибрані → "НЕ ВИБРАНО"
   - Прибрано дублювання інструкції
   - "Замовлення" замінено на "звернення"

### Статус

✔ Змерджено в main  
✔ Production задеплоєно  
✔ Prefill працює коректно
